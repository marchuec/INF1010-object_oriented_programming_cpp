...
//#if TEST_HOPITAL_ACTIF
        ...
        std::vector<std::shared_ptr<Consultation>> consultationsEntreDates = hopital.getConsultationsEntreDates(dateInferieure, dateSuperieure);
        ...
        afficherResultatTest(6, "Hopital::getConsultationsEntreDates", tests.back());
