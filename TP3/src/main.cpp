...
// !!!!!
// J'ai inclus les .cpp car j'ai changé pour CLion et j'ai eu des problèmes de compilation.
// Normalement je ne devrais pas les inclure.
// !!!!!
#include "../src/Patient.cpp"
#include "../src/PatientEtudiant.cpp"
#include "../src/GestionnairePatients.cpp"
#include "../src/Personnel.cpp"
#include "../src/Medecin.cpp"
#include "../src/MedecinResident.cpp"
#include "../src/GestionnairePersonnels.cpp"
#include "../src/Etudiant.cpp"
#include "../src/Consultation.cpp"
#include "../src/ConsultationPhysique.cpp"
#include "../src/ConsultationEnLigne.cpp"
#include "../src/Hopital.cpp"
...
int main()
{
	...
	// Tester l'affichage du patient #1
	...
	// Tester l'affichage du patientEtudiant #2
	...
	// Tester le polymorphisme de l'affichage #3
	...
	// Tester l'affichage du medecin (incluant le test du polymorphisme de la methode) #4
	...
	// Tester le polymorphisme de l'affichage du medecin #5
	...
	// Tester la methode incrementNombreConsultations , getSalaireAnnuel et getPrixConsultation du medecin #6
	...
	// Tester l'affichage du medecin (incluant le test du polymorphisme de la methode) #7
	...
	// Tester le polymorphisme de l'affichage du medecinResident #8
	...
	// Tester la methode incrementNombreConsultations , getSalaireAnnuel et getPrixConsultation du medecin #9
	...
	// Tester le chargement de fichier #10
	...
	// Tester l 'affichage, lireLignePatient et l'operateur += de patient #11
	...
	// Tester getPatientsEtudiants() et getNbPatientsEtudiants() #12
	...
	// Tester l 'affichage, lireLignePersonnel et l'operateur += de personnel	#13 et #14
...
#if true
	// Tester l 'affichage de la consultation #15
	...
	// Tester le calcul du prix de la consultation avec et sans le rabais (polymorphisme inclus dans le test) #16
	...
	// Tester l'ajout d'une consultation (operator+=) #17
	...
	bool test1 = hopital += ConsultationEnLigneTest3;
	bool test2 = medecinDansHopital->getNombreConsultations() == 1;
