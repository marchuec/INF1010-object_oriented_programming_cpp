...
// Test 6 : tester la classe Hopital
	...
	tests.push_back(hopital.getGestionnaireMedecins().getNbMedecins() == 2
	...
	Medecin* medecinExistant = hopital.getGestionnaireMedecins().chercherMedecin("tt1234");
	...
	size_t tailleInitialeMedecins = hopital.getGestionnaireMedecins().getNbMedecins();
	medecinExistant = hopital.getGestionnaireMedecins().chercherMedecin("tt1234");
	tests.push_back(!(hopital += *medecinExistant) && tailleInitialeMedecins == hopital.getGestionnaireMedecins().getNbMedecins()
		&& (hopital += medecinTest) && (tailleInitialeMedecins + 1 == hopital.getGestionnaireMedecins().getNbMedecins()));
